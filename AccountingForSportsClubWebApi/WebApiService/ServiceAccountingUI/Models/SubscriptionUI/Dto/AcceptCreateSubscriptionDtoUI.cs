...
{
    public class AcceptCreateSubscriptionDtoUI
    {
        [JsonProperty(PropertyName = "name", Order = 0, Required = Required.Always)]
        [StringLength(50, MinimumLength = 3, ErrorMessage = "Длина строки должна быть от 3 до 50 символов")]
        public string Name { get; set; }

        [JsonProperty(PropertyName = "amountWorkouts", Order = 1, Required = Required.Always)]
        ...
        [JsonProperty(PropertyName = "clientsId", Order = 4, Required = Required.Default)]
