...
namespace ServiceAccountingUI.Models.TrainingUI.Dto
{
    ...
    public class AcceptUpdateTrainingDtoUI
    {
        ...
        [JsonProperty(PropertyName = "startTraining", Order = 2, Required = Required.AllowNull)]
        public DateTime? StartTraining { get; set; }

        [JsonProperty(PropertyName = "trainerId", Order = 3, Required = Required.Always)]
        [Range(1, int.MaxValue, ErrorMessage = "Значение вышло за пределы допустимого диапозона")]
        public int TrainerId { get; set; }

        [JsonProperty(PropertyName = "servicesId", Order = 4, Required = Required.Always)]
        [Range(1, int.MaxValue, ErrorMessage = "Значение вышло за пределы допустимого диапозона")]
