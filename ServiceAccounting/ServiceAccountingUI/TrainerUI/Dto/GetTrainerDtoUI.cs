...
namespace ServiceAccountingUI.TrainerUI.Dto
{
    ...
    public class GetTrainerDtoUI
    {
        ...
        [DataMember(IsRequired = true, Name = nameof(ServiceId), Order = 5, EmitDefaultValue = true)]
        public int ServiceId { get; set; }

        [DataMember(IsRequired = true, Name = nameof(ServiceId), Order = 6, EmitDefaultValue = true)]
